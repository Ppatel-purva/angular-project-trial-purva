...
@Component({
  selector: 'app-addtoproductdiscription',
  templateUrl: './addtoproductdiscription.component.html',
  styleUrls: ['./addtoproductdiscription.component.css']
})
export class AddtoproductdiscriptionComponent implements OnInit {
